...
namespace monachilada\statictranslations\fields;

use monachilada\statictranslations\StaticTranslations;
use monachilada\statictranslations\assetbundles\statictranslationsfieldfield\StaticTranslationsFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class StaticTranslationsField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('static-translations', 'StaticTranslationsField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'static-translations/_components/fields/StaticTranslationsField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(StaticTranslationsFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').StaticTranslationsStaticTranslationsField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'static-translations/_components/fields/StaticTranslationsField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
