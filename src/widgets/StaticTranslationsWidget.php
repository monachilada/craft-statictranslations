...
namespace monachilada\statictranslations\widgets;

use monachilada\statictranslations\StaticTranslations;
use monachilada\statictranslations\assetbundles\statictranslationswidgetwidget\StaticTranslationsWidgetWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * Static Translations Widget
 *
 ...
 * @since     1.0.0
 */
class StaticTranslationsWidget extends Widget
{
    ...
    {
        return Craft::t('static-translations', 'StaticTranslationsWidget');
    }
    ...
    {
        return Craft::getAlias("@monachilada/statictranslations/assetbundles/statictranslationswidgetwidget/dist/img/StaticTranslationsWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'static-translations/_components/widgets/StaticTranslationsWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(StaticTranslationsWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'static-translations/_components/widgets/StaticTranslationsWidget_body',
            [
